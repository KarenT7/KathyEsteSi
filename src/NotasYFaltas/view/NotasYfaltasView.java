...
import NotasYFaltas.entity.NoExisteClase;
import NotasYFaltas.entity.NotasYfaltas;
...
public class NotasYfaltasView {
	...
	public void addNotasYfaltas() {
		...
		String sql = "Insert into notasyfaltas (IdClase, Faltas, Parcial, NotaFinal)" + "values(?,?,?,?)";
		try {
	...
	public void updateNotasYfaltas() throws NoExisteClase, SQLException {
		...
		conexion.getSentencia().setInt(4, notasYfaltas.getIdClase());
